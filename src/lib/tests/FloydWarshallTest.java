...
public class FloydWarshallTest {
    ...
    public void floydWarshallTest1() {
        ...
        assertArrayEquals(errorMsg, expected, result);
    }
    ...
    public void floydWarshallTest3() {
        ...
        String errorMsg = String.format("Failure - Expected: %s Got: %s", Arrays.deepToString(expected), 
                Arrays.deepToString(result));
        assertArrayEquals(errorMsg, expected, result);
        assertTrue("failure - hasNegativeCycle() should be true", fw.hasNegativeCycle());
    }
